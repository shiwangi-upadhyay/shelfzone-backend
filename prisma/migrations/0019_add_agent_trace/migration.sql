-- CreateTable (already exists in DB, marking as applied)
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "task_traces_owner_id_idx" ON "task_traces"("owner_id");
CREATE INDEX IF NOT EXISTS "task_traces_master_agent_id_idx" ON "task_traces"("master_agent_id");
CREATE INDEX IF NOT EXISTS "task_traces_status_idx" ON "task_traces"("status");
CREATE INDEX IF NOT EXISTS "task_traces_started_at_idx" ON "task_traces"("started_at");
CREATE INDEX IF NOT EXISTS "trace_sessions_task_trace_id_idx" ON "trace_sessions"("task_trace_id");
CREATE INDEX IF NOT EXISTS "trace_sessions_agent_id_idx" ON "trace_sessions"("agent_id");
CREATE INDEX IF NOT EXISTS "trace_sessions_parent_session_id_idx" ON "trace_sessions"("parent_session_id");
...
ALTER TABLE "task_traces" ADD CONSTRAINT "task_traces_master_agent_id_fkey" FOREIGN KEY ("master_agent_id") REFERENCES "agent_registry"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "trace_sessions" ADD CONSTRAINT "trace_sessions_task_trace_id_fkey" FOREIGN KEY ("task_trace_id") REFERENCES "task_traces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "session_events" ADD CONSTRAINT "session_events_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "trace_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
